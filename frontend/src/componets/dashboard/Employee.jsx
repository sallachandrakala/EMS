...
import { FaUsers, FaBuilding, FaMoneyBillWave, FaSignOutAlt } from 'react-icons/fa'
    ...
    <div className='min-h-screen bg-white'>
      <div className='p-8 bg-white'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12'>
          ...
          <SummaryCard icon={<FaBuilding />} text="Active Employees" number={11} color="green" />
          <SummaryCard icon={<FaMoneyBillWave />} text="On Leave" number={2} color="yellow" />
        </div>
