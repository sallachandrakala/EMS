  ...
  const loadDashboardData = async () => {
    try {
      ...
      const userSalaryData = salariesData.filter(salary => 
        salary.employeeId === 'EMP001' || salary.employeeName === 'John Doe'
      )
      const userLeaveData = leavesData.filter(leave => 
        leave.employeeId === 'EMP001' || leave.employeeName === 'John Doe'
      )
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-gradient-to-r from-orange-500 to-orange-600 p-6 rounded-lg text-white">
                <div className="flex items-center justify-between">
                  ...
                  <FaBuilding className="text-3xl text-orange-200" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              <div className="flex items-center space-x-6 mb-6">
                <div className="relative">
                  <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-blue-600 bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center">
                    {imagePreview ? (
                      <img 
                        src={imagePreview} 
                        alt="Profile" 
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute bottom-0 right-0 bg-blue-600 text-white px-3 py-2 rounded-full text-sm hover:bg-blue-700 transition-colors"
                    >
                      <FaCamera />
                    </button>
                  </div>
        ...
        <div className="px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="w-16 h-16 rounded-full overflow-hidden border-4 border-blue-600 bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center shadow-lg">
                {imagePreview ? (
                  <img 
                    src={imagePreview} 
                    alt="Profile" 
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute -bottom-2 -right-2 bg-blue-600 hover:bg-blue-700 text-white p-2 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110"
                >
...
export default Employee1Dashboard
