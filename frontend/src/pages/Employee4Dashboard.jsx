  ...
  const loadDashboardData = async () => {
    try {
      ...
      const userSalaryData = salariesData.filter(salary => 
        salary.employeeId === 'EMP004' || salary.employeeName === 'Sarah Williams'
      )
      const userLeaveData = leavesData.filter(leave => 
        leave.employeeId === 'EMP004' || leave.employeeName === 'Sarah Williams'
      )
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-gradient-to-r from-yellow-500 to-yellow-600 p-6 rounded-lg text-white">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-yellow-100">Total Employees</p>
                    <p className="text-2xl font-bold">{stats.totalEmployees}</p>
                  </div>
                  <FaUsers className="text-3xl text-yellow-200" />
                </div>
              </div>
              <div className="bg-gradient-to-r from-gray-500 to-gray-600 p-6 rounded-lg text-white">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-gray-100">Departments</p>
                    <p className="text-2xl font-bold">{stats.totalDepartments}</p>
                  </div>
                  <FaBuilding className="text-3xl text-gray-200" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              <div className="flex items-center space-x-6 mb-6">
                <div className="relative">
                  <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-pink-600 bg-gradient-to-br from-pink-50 to-pink-100 flex items-center justify-center">
                    {imagePreview ? (
                      <img 
                        src={imagePreview} 
                        alt="Profile" 
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute bottom-0 right-0 bg-pink-600 text-white px-3 py-2 rounded-full text-sm hover:bg-pink-700 transition-colors"
                    >
                      <FaCamera />
                    </button>
                  </div>
                ...
                <div className="flex-1">
                  ...
                  <span className="inline-block px-3 py-1 text-sm bg-pink-100 text-pink-800 rounded-full font-medium">
                    {userData.role}
                  </span>
                  {imagePreview && (
                    <button
          ...
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              ...
              <button
                ...
                className="flex items-center space-x-2 bg-pink-600 hover:bg-pink-700 text-white px-6 py-3 rounded-lg transition-colors"
              >
                <FaPlus />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                <div className="flex items-center justify-between">
                  ...
                  <FaFileAlt className="text-3xl text-pink-600" />
                </div>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                <div className="flex items-center justify-between">
                  ...
                  <FaChartBar className="text-3xl text-pink-600" />
                </div>
              </div>
            </div>
        ...
        <div className="px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="w-16 h-16 rounded-full overflow-hidden border-3 border-pink-600 bg-gradient-to-br from-pink-50 to-pink-100 flex items-center justify-center shadow-lg">
                {imagePreview ? (
                  <img 
                    src={imagePreview} 
                    alt="Profile" 
              ...
              <div className="relative">
                ...
                <button
                  type="button"
                  onClick={() => document.querySelector('input[type="file"]').click()}
                  className="absolute -bottom-2 -right-2 bg-pink-600 hover:bg-pink-700 text-white p-2 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110"
                >
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 flex items-center space-x-2">
                  ...
                  <span className="inline-block px-2 py-1 text-xs bg-pink-100 text-pink-800 rounded-full font-medium">
                    {userData.role}
                  </span>
                </p>
              </div>
...
export default Employee4Dashboard
