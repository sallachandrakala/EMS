            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              <div className="flex items-center space-x-6 mb-6">
                <div className="relative">
                  <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-teal-600 bg-gradient-to-br from-teal-50 to-teal-100 flex items-center justify-center">
                    {imagePreview ? (
                      <img 
                        src={imagePreview} 
                        alt="Profile" 
                ...
                <div className="flex-1">
                  ...
                  <span className="inline-block px-3 py-1 text-sm bg-teal-100 text-teal-800 rounded-full font-medium">
